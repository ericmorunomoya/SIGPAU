...
Aparte de corregir el repositorio, se ha verificado y ejecutado el cambio real de claves conectando vía SSH a la infraestructura:
...
- **LDAP Slave (10.120.17.242):** Se modificó la clave de root y se actualizó de inmediato la cadena de sincronización (Syncrepl) para que continúe replicando usando las nuevas credenciales en lugar de las comprometidas.
- **NAS (10.1.100.17):** Se forzó el cambio del usuario `root` desde su clave anterior para unificar la política en la infraestructura.
